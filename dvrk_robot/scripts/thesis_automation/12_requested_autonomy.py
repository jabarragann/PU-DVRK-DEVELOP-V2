...
class MainModule:
    ...
    def __init__(self, args):
        ...
        self.blood_percentage_pub = rospy.Publisher("/recording_module/blood_percentage",Float32, queue_size=5)
...
def script_config_arg():
    ...
    parser.add_argument('-a', '--activate_ar', action='store_true', default=True, help='activate AR visualization (default: True)')
    ...
    #parser.add_argument('-m', '--operation_mode', action='store', default='pedal', help='Operation mode for the system. This value should be "pedal" or "cognitive" (default: pedal)')

    args = parser.parse_args()
    #assert args.operation_mode in ["pedal", "cognitive"]
    return args
